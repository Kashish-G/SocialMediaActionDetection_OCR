...
roi_x = int(800/ width * 100)  # Convert to percentage
roi_y = int(480/ height * 100)  # Convert to percentage
roi_width = int(250/ width * 100)  # Convert to percentage
...
if "Follow" in initial_text and "Following" in final_text:
    print("User followed on Twitter!")
elif "Following" in initial_text and "Follow" in final_text:
    print("User unfollowed on Twitter!")
else:
