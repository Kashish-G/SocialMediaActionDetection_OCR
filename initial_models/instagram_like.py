...
roi_x = int(720 / width * 100)  # Convert to percentage
roi_y = int(1570 / height * 100)  # Convert to percentage
roi_width = int(200 / width * 100)  # Convert to percentage
...
initial_likes = int(''.join(filter(str.isdigit, initial_text)))
final_likes = int(''.join(filter(str.isdigit, final_text)))
